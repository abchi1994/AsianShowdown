...
exports.Formats = [
	...
	{
		name: "RNG ONLY - Does not work",
		desc: ["Togepi with metronome"],
		section: "ORAS Singles",
		mod: 'togepi',
		team: 'random',
		ruleset: ['HP Percentage Mod', 'Cancel Mod',],
		
		banlist: ['Monster', 'Water 1', 'Bug', 'Flying', 'Field', 'Fairy', 'Grass', 'Human-Like', 'Water 3', 'Mineral', 'Amorphous', 'Water 2', 'Ditto', 'Dragon',
		'Pikachu', 'Nidorina', 'Nidoqueen', 'Arceus', 'Dialga', 'Giratina', 'Giratina-Origin', 'Groudon', 'Ho-Oh', 'Kyogre', 'Kyurem-White', 'Lugia',
			'Mewtwo', 'Palkia', 'Rayquaza', 'Reshiram', 'Salamence-Mega', 'Salamencite', 'Shaymin-Sky', 'Xerneas', 'Yveltal',
			'Zekrom','Zapdos', 'Moltres', 'Articuno', 'Entei', 'Raikou', 'Suicune', 'Regigigas', 'Regirock', 'Regice', 'Registeel', 'Latios', 'Latias',
			'Azelf', 'Uxie', 'Mesprit', 'Cresselia', 'Heatran', 'Cobalion', 'Terrakion', 'Virizion', 'Victini', 'Tornadus', 'Thundurus', 'Landorus', 
			'Landorus-Therian', 'Tornadus-Therian', 'Thundurus-Therian', 'Kyuren', 'Kyurem-Black', 'Zygarde', 'Volcanion', 'Hoopa', 'Hoopa-Unbound', 'Diancie',
			'Mew', 'Celebi', 'Shaymin', 'Jirachi', 'Deoxys', 'Deoxys-Attack', 'Deoxys-Defense', 'Deoxys-Speed', 'Darkrai', 'Manaphy', 'Phione', 'Keldeo', 'Meloetta', 'Genesect',
			'Pichu', 'Cleffa', 'Igglybuff', 'Unown', 'Tyrogue', 'Smoochum', 'Elekid', 'Magby', 'Azurill', 'Wynaut', 'Budew', 'Chingling', 'Bonsly', 'Mime Jr.', 'Happiny',
			'Munchlax', 'Riolu', 'Mantyke'],
		
	},
	
	{
		name: "Random Battle No Legendaries - Doesn't Work",
		desc: ["Randomized teams of level-balanced Pok&eacute;mon with sets that are generated to be competitively viable. But no legendaries cause cause"],
		section: "ORAS Singles",
